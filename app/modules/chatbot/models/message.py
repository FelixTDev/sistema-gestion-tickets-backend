...
class ChatMessage(SQLModel, table=True):
    ...
    conversation_id: str = Field(foreign_key="conversations.id", max_length=36, index=True)
    ...
    confidence: float | None = Field(default=None, sa_column=Column(Numeric(5, 4), nullable=True))
