...
class Conversation(SQLModel, table=True):
    ...
    user_id: str | None = Field(default=None, foreign_key="users.id", max_length=36, index=True)
    status: ConversationStatus = Field(default=ConversationStatus.ACTIVE, sa_column=Column(Enum(ConversationStatus), nullable=False))
